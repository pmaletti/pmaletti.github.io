...
<div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">Efficient Large Language Models</span>
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">Neural Architecture Search</span>
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">Model Compression & Pruning</span>
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">Generative Models</span>
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">ML Memorization</span>
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">Sparse Autoencoders & Dictionary Learning</span>
  <span style="background-color: transparent; color: #b06d85; padding: 6px 15px; border-radius: 50px; font-weight: 600; font-size: 0.9em; border: 2px solid #b06d85;">Neuromorphic Computing</span>
</div>
